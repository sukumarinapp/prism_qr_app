...
<html lang="en">
  ...
  <body class="bg-light text-black">
    ...
    <nav class="navbar fixed-bottom navbar-expand-lg navbar-dark bg-info">
      <a class="btn btn-sm btn-danger font-weight-bold" href="menu.php?cstcod=<?php echo $cstcod; ?>&rescod=<?php echo $rescod; ?>&tblnub=<?php echo $tblnub; ?>&mobile=<?php echo $mobile; ?>" >Menu</a>
      <?php
      if($cart_quantity>0 && $allow_checkout==0){
      ?>
      <a class="btn btn-sm btn-danger font-weight-bold" href="pay.php?cstcod=<?php echo $cstcod; ?>&oid=<?php echo $order_id; ?>" >Checkout</a>
      <?php
