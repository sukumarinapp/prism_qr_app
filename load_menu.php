...
$sql = "select a.MENGRP,a.ITMNAM,a.ITMCOD,b.PRICE,b.TAXSTR,c.LNGNAM,a.DESCRP,STKOUT from posmas a,posrat b,set100 c where  a.MENGRP=c.GRPCOD and a.property_id=b.property_id and a.property_id=c.property_id and a.property_id='$property_id' and a.ITMCOD=b.ITMCOD and b.RESCOD='$rescod'"; 
...
?>
	<div class="row clearfix no-gutters">
		<div class="col-md-12 col-sm-12 col-xs-12">
		    <div style="background-color:lightgrey;" class="card text-black">
			  <div class="card-body ">
			  	<div class="row">
